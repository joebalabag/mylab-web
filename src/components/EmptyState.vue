...
<template>
  <div class="flex flex-col items-center justify-center gap-2 py-16 text-center text-slate-500">
    <svg viewBox="0 0 24 24" class="h-10 w-10 text-slate-300" fill="none" stroke="currentColor" stroke-width="1.5"
    ...
    <div v-if="message" class="max-w-sm text-xs text-slate-500">{{ message }}</div>
